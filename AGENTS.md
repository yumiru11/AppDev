...
- `docs/adr/` — 架构决策记录（编号 `NNNN-标题.md`；当前 0001-0006 覆盖认证/存储/主题/渲染分层/UI 导航视觉；新决策经 grill-with-docs 会话产生）
- `docs/ui-design.md` — UI 设计规范（**权威参考，2026-08-15 两轮 grill 拍板版**：两层导航/玻璃清单/卡片/动效/图标；所有 UI ticket 必须遵循）
- `docs/research/` — 调研报告（webview-material-you-fusion.md、highlight-engine-analysis.md）
