...
fun lightPalette(): ThemeColors = ThemeColors(
...
fun darkPalette(): ThemeColors = ThemeColors(
...
fun oledPalette(): ThemeColors = ThemeColors(
    colorScheme = darkColorScheme(
...
fun highContrastLightPalette(): ThemeColors = ThemeColors(
    colorScheme = lightColorScheme(
...
fun highContrastDarkPalette(): ThemeColors = ThemeColors(
    colorScheme = darkColorScheme(
