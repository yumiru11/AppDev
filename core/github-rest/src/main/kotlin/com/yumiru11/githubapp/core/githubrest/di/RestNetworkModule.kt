...
object RestNetworkModule {
    ...
    @Provides
    @Singleton
    fun provideRepoManagementApi(retrofit: Retrofit): RepoManagementApi = retrofit.create(RepoManagementApi::class.java)
    ...
    @Provides
    @Singleton
    fun providePullRequestApi(retrofit: Retrofit): PullRequestApi = retrofit.create(PullRequestApi::class.java)
    ...
    @Provides
    @Singleton
    fun provideGitRefApi(retrofit: Retrofit): GitRefApi = retrofit.create(GitRefApi::class.java)
